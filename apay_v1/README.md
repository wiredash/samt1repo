...
This is a sample template for apay_v1 - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name apay_v1 --tail
```
...
```bash
aws cloudformation delete-stack --stack-name apay_v1
```
