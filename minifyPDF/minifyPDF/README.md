...
This is a sample template for minifyPDF - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name minifypdf --tail
```
...
```bash
aws cloudformation delete-stack --stack-name minifypdf
```
