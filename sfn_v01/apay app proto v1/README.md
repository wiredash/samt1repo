...
This is a sample template for apay app proto v1 - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name apay-app-proto-v1 --tail
```
...
```bash
aws cloudformation delete-stack --stack-name apay-app-proto-v1
```
